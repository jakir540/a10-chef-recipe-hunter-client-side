    ...
    <section>
      ...
      <div className="card w-96 bg-base-400 shadow-xl image-full  h-96 md:mx-3">
        ...
        <div className="card-body divide-y-4 divide-white-200 md:p-8">
          ...
          <p className="text-white py-4 text-2xl">Provide with our Gift Card to whome you most want and is sure Food refers to any substance that is consumed to provide nutritional  </p>
      ...
      <div className="card w-96 bg-yellow-900 shadow-xl image-full  h-96 mx-3">
        ...
        <div className="card-body divide-y-4 divide-white-200 p-8">
          <h2 className="card-title">BUY GIFT CARDS ONLINE!</h2>
          <p className="text-white py-4 text-2xl">get recipes tips and news delivered to your inbox  </p>
            <div>
            <input className="p-5 my-2 bg-transparent border capitalize" type="email" placeholder="enter your email" />
            </div>
          <div className="card-actions justify-end">
      ...
      <div className="card w-96 bg-slate-900 shadow-xl image-full  h-96 mx-3">
        ...
        <div className="card-body divide-y-4 divide-white-200 p-8">
          ...
          <p className="text-white py-4 text-2xl">here you,ll find a carefully chosen kitchen inventory </p>
          <div className="card-actions justify-end">
       ...
       <div className="card w-96 bg-base-400 shadow-xl image-full  h-96 mx-3">
        ...
        <div className="card-body divide-y-4 divide-white-200 p-8">
          <h2 className="card-title">BUY GIFT CARDS ONLINE!</h2>
          <p className="text-white py-4 text-2xl">Provide with our Gift Card to whome you most want a  </p>
          <div className="card-actions justify-end">
            <button className="btn bg-yellow-900 mt-5">GIFT CARD</button>
          </div>
        </div>
